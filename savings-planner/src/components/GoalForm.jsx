...
const GoalForm = ({ addGoal }) => {
  ...
  return (
    <div className="text-right">
      ...
      {isOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 backdrop-blur-sm">Add commentMore actions
          <div className="bg-white rounded-2xl p-8 w-full max-w-md shadow-2xl relative">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Create New Goal</h2>Add commentMore actions
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              />
              <select
                cclassName="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                value={currency}
